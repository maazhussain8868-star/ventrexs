      ...
      <div className="space-y-6">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-1">
            ...
            <span className="text-3xl font-black text-slate-900 font-mono">{telemetry.todayCalls.toLocaleString()}</span>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-1">
            ...
            <span className="text-3xl font-black text-slate-900 font-mono">{telemetry.totalTokens}</span>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-1">
            ...
            <span className="text-3xl font-black text-emerald-600 font-mono">{telemetry.avgLatency}</span>
          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-5 shadow-xs space-y-1">
            ...
            <span className="text-3xl font-black text-emerald-600 font-mono">{telemetry.safetyPassRate}</span>
